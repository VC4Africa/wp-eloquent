...
class WpPdo extends PDO
{
     ...
     */
    #[ReturnTypeWillChange] public function beginTransaction() : bool
    {
     ...
     */
    #[ReturnTypeWillChange] public function commit() : bool
    {
        if( ! $this->in_transaction ) {
     ...
     * @throws PDOException if there is no active transaction.
     */
    #[ReturnTypeWillChange] public function rollBack() : bool
    {
        if( ! $this->in_transaction ) {
     ...
     */
    #[ReturnTypeWillChange] public function inTransaction() : bool
    {
     ...
     * </code>
     */
    #[ReturnTypeWillChange] public function exec( string $statement ) : bool|int
    {
     ...
     * IM001 SQLSTATE.
     */
    #[ReturnTypeWillChange] #[Pure] public function lastInsertId( $name = null ) : string
    {
